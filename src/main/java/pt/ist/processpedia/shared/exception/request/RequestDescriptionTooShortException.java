...
package pt.ist.processpedia.shared.exception.request;

import pt.ist.processpedia.shared.exception.ProcesspediaException;

public class RequestDescriptionTooShortException extends ProcesspediaException {

  private String requestDescription;
  private int minLengthAllowed;

  public RequestDescriptionTooShortException() {}

  public RequestDescriptionTooShortException(String requestDescription, int minLengthAllowed) {
